...
formula1 <- as.formula(paste("winner_binary ~", fixed_effects, "+ (1 | team1)
                             + (1 | team2)"))

# Option 2: Add season as random intercept
formula2 <- as.formula(paste("winner_binary ~", fixed_effects, "+ (1 | season) 
                             + (1 | team1) + (1 | team2)"))

# Option 3: Add venue as another grouping factor
formula3 <- as.formula(paste("winner_binary ~", fixed_effects, "+ (1 | season)
                             + (1 | venue) + (1 | team1) + (1 | team2)"))

# Option 3.1: Add random slope for run_rate_difference by team 
formula3.1 <- as.formula(paste("winner_binary ~", fixed_effects, 
